...
function createData(id, username, accountType, paperName, modelName) {
...
const headCells = [
    ...
    { id: 'paperName', numeric: true, disablePadding: false, label: 'Paper Name' },
    { id: 'modelName', numeric: true, disablePadding: false, label: 'Model Name' },
];
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right">{row.paperName}</TableCell>
